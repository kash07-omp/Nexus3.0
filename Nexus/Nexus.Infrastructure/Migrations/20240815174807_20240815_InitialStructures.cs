...
{
    /// <inheritdoc />
    public partial class _20240815_InitialStructures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Description",
                value: "Extracts minerals from the planetary crust.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                column: "Description",
                value: "Produces microchips necessary for advanced technology.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                column: "Description",
                value: "Extracts hydrogen, used as fuel for ships and energy.");

            migrationBuilder.UpdateData(
                table: "Structures",
                keyColumn: "Id",
                keyValue: 4,
                columns: new[] { "Description", "DistrictId" },
                values: new object[] { "Improves work management in the mineral mine, increasing efficiency by 10%.", 2 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, "Central hub of the city where laws are enacted and the region is administered.", 1, null, "Ayuntamiento" },
                    { 6, "A network of hive buildings where the majority of your population lives.", 1, null, "Zona residencial" },
                    { 7, "Bureaucrats work here to collect taxes from citizens.", 1, null, "Sede de Hacienda" },
                    { 8, "Protects citizens from disease and heals troops.", 1, null, "Centro médico" },
                    { 9, "Combines biotechnology and robotics to heal patients using nanobots.", 1, null, "Centro de medicina avanzada" },
                    { 10, "Facilitates drainage and improves regional sanitation.", 1, null, "Sistema de alcantarillado" },
                    { 11, "Heavy industry minds work here to improve microchip production by 10%.", 2, null, "Departamento de I+D" },
                    { 12, "Facilitates hydrogen processing, increasing extraction efficiency by 10%.", 2, null, "Red de tuberías de hidrógeno" },
                    { 13, "Provides energy to the region. Each level adds more energy points.", 2, null, "Reactor nuclear" },
                    { 14, "Modern assembly techniques and AI enable the construction of robots for work, increasing construction speed by 5%.", 2, null, "Fábrica de autómatas" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Description",
                value: "Extrae minerales de la corteza planetaria.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                column: "Description",
                value: "Produce microchips necesarios para tecnología avanzada.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                column: "Description",
                value: "Extrae hidrógeno, utilizado como combustible para naves y energía.");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "DistrictId" },
                values: new object[] { "Mejora la gestión del trabajo en la mina de minerales, aumentando en un 10% su eficiencia.", 1 });
